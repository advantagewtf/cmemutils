...
4. [Random Functions](#random-functions)
    ...
    2. [randint()](#randint)
5. [Windows Utilities Class](#windows-utilities-class)
    1. [clear()](#clear)
...
6. [WindowsAPI Class](#windowsapi-class)
